...
\t\t\t<p>";
        // line 4
        echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["paragraph"] ?? null), "field_url", [], "any", false, false, true, 4), "value", [], "any", false, false, true, 4), 4, $this->source), "html", null, true);
        echo "</p>
\t\t\t<p>";
        // line 5
...
\t\t\t";
        // line 8
        echo $this->extensions['Drupal\Core\Template\TwigExtension']->renderVar($this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["paragraph"] ?? null), "field_summary", [], "any", false, false, true, 8), "value", [], "any", false, false, true, 8), 8, $this->source));
        echo "
\t\t</div>
\t</div>
</section>
...
\t<div class=\"card-work-experience\">
\t\t<div class=\"work-details\">
\t\t\t<p>{{paragraph.field_url.value}}</p>
\t\t\t<p>{{paragraph.field_title.value}}</p>
\t\t</div>
\t\t<div class=\"details-work\">
...
", "themes/custom/abogados/templates/paragraph/paragraph--work-experience.html.twig", "/app/web/themes/custom/abogados/templates/paragraph/paragraph--work-experience.html.twig");
    ...
    {
        static $tags = array();
        static $filters = array("escape" => 4, "raw" => 8);
