...
class __TwigTemplate_511e2eae7af8cf0c1ae6eca64945180d6164668710b17e9a8336f092d1981cb3 extends \Twig\Template
{
    private $source;
    private $macros = [];
  ...
  <div class=\"item-information schedule\">
    ...
    {
        return new Source("<div class=\"contact-information\">
  <div class=\"item-information phone\">
    <p><i class=\"fas fa-phone-alt\"></i> {{ paragraph.field_phone.value }}</p>
  </div>
  <div class=\"item-information email\">
    <a href=\"mailto:{{ paragraph.field_email.value }}\"><i class=\"far fa-envelope\"></i> {{ paragraph.field_email.value }}</a>
  </div>
  <div class=\"item-information schedule\">
    <p><i class=\"far fa-clock\"></i> {{ paragraph.field_schedule.value }}</p>
  </div>
</div>", "themes/custom/abogados/templates/paragraph/paragraph--contact-information.html.twig", "/app/web/themes/custom/abogados/templates/paragraph/paragraph--contact-information.html.twig");
    }
